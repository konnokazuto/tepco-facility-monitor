...
import { InstallationSidebar } from "@/features/installation/InstallationSidebar";
...
function InstallationContent() {
  ...
  return (
    <div className="flex-1 flex flex-col">
      <header
        className={cn(
          "flex pt-2 h-16 shrink-0 items-center gap-2.5 border-b px-4 bg-gray-100 transition-opacity duration-500",
